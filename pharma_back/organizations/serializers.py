...
from .models import Organization, Branch, OrganizationSettings, SubscriptionPlan, OrganizationSubscription, BillingHistory
...
class OrganizationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Organization
        fields = [
            'id', 'name', 'type', 'medical_system', 'status', 'owner', 'owner_name',
...
class OrganizationCreateSerializer(serializers.ModelSerializer):
    ...
    medical_system = serializers.ChoiceField(
        choices=Organization.MEDICAL_SYSTEM_CHOICES,
        required=False,
        default=Organization.ALLOPATHIC
    )
    ...
    class Meta:
        model = Organization
        fields = [
            'name', 'type', 'medical_system', 'owner', 'address', 'city', 'state',
...
class OrganizationUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Organization
        fields = [
            'name', 'type', 'medical_system', 'status', 'address', 'city', 'state',
            'postal_code', 'country', 'phone', 'email', 'website',
            'license_number', 'license_expiry', 'tax_id', 'registration_number',
            'currency', 'tax_rate', 'timezone', 'language',
            'subscription_plan', 'subscription_status', 'subscription_expiry'
...
class OrganizationWithOwnerSerializer(serializers.Serializer):
    ...
    medical_system = serializers.ChoiceField(choices=Organization.MEDICAL_SYSTEM_CHOICES, required=False, default=Organization.ALLOPATHIC)
...
class BillingHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'transaction_type', 'status', 'amount', 'currency', 'invoice_number',
